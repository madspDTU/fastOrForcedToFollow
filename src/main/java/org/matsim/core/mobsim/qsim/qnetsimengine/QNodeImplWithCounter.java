 ...
 */
final class QNodeImplWithCounter extends AbstractQNode {
	private static final Logger log = Logger.getLogger(QNodeImplWithCounter.class);
	public static class Builder {
		...
		public QNodeImplWithCounter build( Node n ) {
			return new QNodeImplWithCounter( n, context, netsimEngine, turnAcceptanceLogic ) ;
		}
	}
	...
	private QNodeImplWithCounter(final Node n, NetsimEngineContext context, NetsimInternalInterface netsimEngine2, TurnAcceptanceLogic turnAcceptanceLogic) {
		super(n) ;
		this.netsimEngine = netsimEngine2 ;
		this.context = context ;
		this.turnAcceptanceLogic = turnAcceptanceLogic;
