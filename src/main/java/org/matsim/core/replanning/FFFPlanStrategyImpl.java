 ...
 */
public final class FFFPlanStrategyImpl extends FFFGenericPlanStrategyImpl<Plan, Person> implements PlanStrategy {
	...
	public final static class Builder {
		...
		public final PlanStrategy build() {
			FFFPlanStrategyImpl impl = new FFFPlanStrategyImpl(planSelector) ;
	...
	public FFFPlanStrategyImpl(final PlanSelector<Plan, Person> planSelector) {
		super(planSelector);
	}	
