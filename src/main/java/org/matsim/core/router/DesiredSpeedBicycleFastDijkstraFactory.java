...
@Singleton
public class DesiredSpeedBicycleFastDijkstraFactory implements LeastCostPathCalculatorFactory {
	...
	@Inject
	public DesiredSpeedBicycleFastDijkstraFactory() {
		this(false, FastRouterType.ARRAY);
	}

	public DesiredSpeedBicycleFastDijkstraFactory(final boolean usePreProcessData) {
		this(usePreProcessData, FastRouterType.ARRAY);
	}

	private DesiredSpeedBicycleFastDijkstraFactory(final boolean usePreProcessData, final FastRouterType fastRouterType) {
