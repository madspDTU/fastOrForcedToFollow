...
public class MyIntersectionSimplifier {
	...
	public MyIntersectionSimplifier(double epsilon, int pmin, boolean silent) {
	...
	public Network simplify(Network network) {
		...
		this.djc = new DensityCluster(nodes, this.silent);
		...
		for(Link link : network.getLinks().values()) {
			...
			newLink.getAttributes().putAttribute("type", link.getAttributes().getAttribute("type"));
