...
public class BicycleTimeoutModifierPartialLeftTurn extends TimeoutModifier {
	...
	public void updateTimeouts(double[][] bicycleTimeouts, double[][] carTimeouts, int inDirection, int outDirection,
		...
		//Not blocking the outdirection (which isn't really the outdirection, but the bundle following the hangoutlocation);

		// If indirection = "outdirection + 1". _Rightest_ possible turn.
		int outDirectionMinusOne =  QFFFNodeUtils.decreaseInt(outDirection, n);
